...
static constexpr uint8_t UDP_V3_MESSAGE_FRAME_CHUNK = 0x03;
...
static constexpr size_t UDP_V3_CHUNK_DESCRIPTOR_LEN = 10;
...
static constexpr size_t UDP_V3_MAX_PACKET_LEN = 65507;
...
struct UdpV3ChunkFrame {
  ...
  uint8_t chunk_count;
  uint16_t payload_len;
  UdpV3ChunkView chunks[MAX_OUTPUTS];
};
