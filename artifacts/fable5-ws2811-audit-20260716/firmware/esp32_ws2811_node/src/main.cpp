...
constexpr const char *kBackendName = "spi6_dma_fixed_gpio4";
constexpr uint32_t kBackendClockHz = light_belt::WS2811_SPI6_CLOCK_HZ;
#else
...
void printStartupIdentity() {
  ...
  Serial.printf(
      ...
      "gpio4_bits_per_ws=6 gpio4_t0h_ns=200 gpio4_t1h_ns=600 "
      "gpio4_reset_low_us=500 routing=permanent\n",
      static_cast<unsigned long>(light_belt::WS2811_SPI6_CLOCK_HZ));
#elif defined(LIGHT_BELT_FIXED_GPIO4_SPI)
  Serial.printf(
      "node_timing gpio4_transport=spi2 gpio4_hz=%lu "
