...
def verify(root: Path) -> None:
    contracts = [
        "docs/history/campaigns/show-orchestration-v1/contracts/FRAME_CONTRACT.md",
        "docs/history/campaigns/show-orchestration-v1/contracts/COMPOSE_CONTRACT.md",
        "docs/history/campaigns/show-orchestration-v1/contracts/TIME_CONTRACT.md",
        "docs/history/campaigns/show-orchestration-v1/contracts/MUSIC_CONTROL_CONTRACT.md",
        "docs/history/campaigns/show-orchestration-v1/contracts/QUALITY_GATE_CONTRACT.md",
    ...
    campaign_dir = root / ".agent/archive/campaigns/show-orchestration-v1"
    ...
    full = json.loads((campaign_dir / "full-campaign.json").read_text(encoding="utf-8"))
